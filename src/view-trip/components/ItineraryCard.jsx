...
const ItineraryCard = ({ plan }) => {
  ...
  return (
    <Link
      ...
      target="_blank"
    >
      <div className="flex flex-col bg-white rounded-xl shadow-md overflow-hidden transition-transform transform hover:scale-105 duration-300 cursor-pointer mt-2 border">
        <img
        ...
        <div className="p-4">
          ...
          <p className="flex items-center text-md mb-1 text-gray-600">
            <GiTicket className="text-pink-500 mr-1" />
