...
const Hero = () => {
  ...
  return (
    <div className="text-white h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden">
      {/* Background Video */}
      <Parallax className="absolute top-0 left-0 w-full h-full z-0" y={[-50, 50]}>
        <video
      ...
      {/* Hero Content */}
      <div className="relative z-10 bg-gradient-to-b from-sky-100 to-white p-6 rounded-lg shadow-md text-black text-center">
        <h1 className="text-5xl font-extrabold hero-title mb-4">
          Discover Your Perfect Trip with AI Trip Planner
        </h1>
        <p className="text-xl hero-description mb-3 font-semibold">
          AI Trip Planner is your ultimate AI-powered travel companion. Tell us
        ...
        <div className="cta-section">
          ...
          <Link to="/create-trip">
          <Button className="py-3 px-6 text-lg font-bold bg-sky-500 hover:bg-sky-600">
            Start Planning Now
          </Button>
